...
import { ITEM_ACTION_BUTTON_BASE_CLASS, ITEM_ACTION_ICON_CLASS } from '../AlarmButton';

/**
 * Copy-to-clipboard button for item names.
 * Shared by ItemRow / TimedView / MapView (previously three identical copies).
 */
export const CopyNameButton: React.FC<{ text: string; title?: string }> = ({ text, title = 'Copy Name' }) => {
