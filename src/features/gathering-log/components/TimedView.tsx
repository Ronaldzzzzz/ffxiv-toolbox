                ...
                <div className="p-3 flex-grow flex flex-col">
                    ...
                    <div className="flex items-start gap-3 mb-2">
                        ...
                        <div className="flex-grow min-w-0">
                            <h4 className="font-bold text-sm text-slate-800 dark:text-slate-200 truncate leading-tight mb-1 flex items-center gap-1" title={getLocalizedText(item, lang)}>
                                ...
                                <button
                                    ...
                                    className={`transition-colors flex items-center justify-center w-5 h-5 rounded hover:bg-slate-100 dark:hover:bg-slate-700 ${isBookmarked ? 'text-yellow-500' : 'text-slate-300 dark:text-slate-600 hover:text-yellow-500'}`}
                                    title="Bookmark"
                                >
